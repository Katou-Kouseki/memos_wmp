...
默认注册后的语言为英文，可以点击左侧侧滑栏语言切换为中文。
 #Welcom 
欢迎注册碎碎念想🎉现在你需要了解一下它的使用方法~
碎碎念想是基于**笔记类**开源web项目[memos](https://github.com/usememos/memos)定制的微信小程序客户端，并且你也可以通过网页使用memo，网址是**https://memos.kouseki.cn**，以下是使用说明(**当然你也可以点击右上角编辑查看语法，这条memo基本涵盖了所有语法**)：
...
#Welcome
Welcome to register for Memos 🎉 Now you need to learn about Memos and how to use it~ 
